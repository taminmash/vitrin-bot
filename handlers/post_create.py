...
if step == "confirm":
    ...
    if text == "✅ تایید و ارسال":
        ...
        post_id = save_post(
            ...
            category=context.user_data["post_category"],
            city=context.user_data["post_city"],
            display_name=context.user_data["post_name"],
            telegram_id=context.user_data["post_telegram"],
        ...
        await update.message.reply_text(
            "✅ آگهی شما ثبت شد و برای بررسی ادمین ارسال گردید."
        )
